...
My_MAC_IP_addr_block:  process (mac_clk, rst_macclk)
  variable Got_MAC_IP_addr_rx, last_enable_125, need_load: std_logic;
  ...
  begin
    if rst_macclk = '1' then
      ...
      MAC_addr_int := (Others => '0');
      IP_addr_int := (Others => '0');
...
-- Sample MAC_addr & IP_addr on enable going high, or on the first cycle out of reset...
      if need_load = '1' or (enable_125 = '1' and last_enable_125 = '0') then
        Got_MAC_IP_addr_rx := '0';
