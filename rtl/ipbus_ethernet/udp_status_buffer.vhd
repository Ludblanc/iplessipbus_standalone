...
header_block:  process (mac_clk, rst_macclk)
...
-- pragma translate_on
      ...
      if pkt_rcvd = '1' and reliable_packet = '1' then
...
history_block:  process (mac_clk, rst_macclk)
...
async_history_block: process(mac_clk, rst_macclk)
...
ipbus_in_block:  process (mac_clk, rst_macclk)
  begin
    if rst_macclk = '1' then
      ipbus_in <= (Others => '0')
-- pragma translate_off
...
ipbus_out_block:  process (mac_clk, rst_macclk)
  begin
    if rst_macclk = '1' then
      ipbus_out <= (Others => '0')
-- pragma translate_off
