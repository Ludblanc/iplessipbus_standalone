...
pkt_done_ipb_clk: process(ipb_clk, rst_ipb)
  begin
    if rst_ipb = '1' then
      pkt_done_r_tff <= "000";
      pkt_done_w_tff <= "000";
...
req_send_mac_clk: process(mac_clk, rst_macclk)
  begin
...
pkt_rdy_ipb_clk: process(ipb_clk, rst_ipb)
...
busy_mac_clk: process(mac_clk, rst_macclk)
  begin
    if rst_macclk = '1' then
      busy_up_tff <= '0';
      busy_down_tff <= '0';
...
busy_ipb_clk: process(ipb_clk, rst_ipb)
