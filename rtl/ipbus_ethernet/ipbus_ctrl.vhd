...
-- '0' => RARP, '1' => DHCP
	...
	port(
		...
		rst_macclk: in std_logic; -- MAC clock domain async reset
		ipb_clk: in std_logic; -- IPbus clock
		rst_ipb: in std_logic; -- IPbus clock domain async reset
		...
		ipbus_port: in std_logic_vector(15 DOWNTO 0) ; -- UDP port for IPbus traffic in this instance of UDP I/F
		enable: in std_logic ;
		ipam_select: in std_logic ;
...
architecture rtl of ipbus_ctrl is
  signal oob_out :ipbus_trans_out_array(N_OOB - 1 downto 0);
  signal oob_in:  ipbus_trans_in_array(N_OOB - 1 downto 0);
